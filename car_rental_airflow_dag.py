...
PROJECT_ID = 'analog-octagon-469617-c1'
REGION = 'us-central1'

pyspark_job_file_path = 'gs://snowflake-projects-test/car_rental_spark_job/spark_job.py'
...
PYSPARK_JOB = {
    ...
    "pyspark_job": {
        ...
        "jar_file_uris": [
            "gs://snowflake-projects-test/snowflake_jar/spark-snowflake_2.12-2.15.0-spark_3.4.jar",
            "gs://snowflake-projects-test/snowflake_jar/snowflake-jdbc-3.16.0.jar"
        ]
    }
}
