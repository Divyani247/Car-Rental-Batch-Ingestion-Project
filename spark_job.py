...
def process_car_rental_data(data_date):
    ...
    gcs_file_path = f"gs://snowflake-projects-test/car_rental_data/car_rental_daily_data/car_rental_{data_date}.json"
    ...
    snowflake_options = {
        "sfURL": "ryjvfay-pd21599.snowflakecomputing.com",
        "sfAccount": "RYJVFAY-PD21599",
        "sfUser": "DIVYANI247",
        "sfPassword": "Divyahirulkar247",
